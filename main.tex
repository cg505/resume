...
\begin{minipage}[t]{0.665\textwidth}
  ...
  \begin{adjustwidth}{10pt}{}
    ...
    \textbf{Merged} \link{https://github.com/pulls?q=is\%3Apr+author\%3Acg505+repo\%3Abrave\%2Fbrave-core+repo\%3Abrave\%2Fbrave-ui+repo\%3Abrave\%2Fethereum-remote-client}{dozens of pull requests} that are public on GitHub.
  \end{adjustwidth}

  \vspace{5pt}
  \textbf{Kelda}\quad\link{https://www.kelda.io}{kelda.io}\hfill Berkeley, CA
  \begin{adjustwidth}{10pt}{}
