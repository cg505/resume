...
\begin{minipage}[t]{0.665\textwidth}
  ...
  \begin{adjustwidth}{10pt}{}
    ...
    \impact{\textbf{Built} Blimp, a distributed tool to enable software development in the cloud}, as part of a tiny startup team.
  ...
  \begin{adjustwidth}{10pt}{}
    ...
    \textbf{Restructured} the company's \impact{microservice request handling} Scala library.
