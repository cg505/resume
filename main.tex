...
\begin{minipage}[t]{0.665\textwidth}
  ...
  \begin{adjustwidth}{10pt}{}
    ...
    \textbf{Merged} \link{https://github.com/search?q=is\%3Apr+author\%3Acg505+repo\%3Abrave\%2Fbrave-core+repo\%3Abrave\%2Fbrave-ui+repo\%3Abrave\%2Fethereum-remote-client&s=updated&o=asc}{dozens of pull requests} that are public on GitHub.
  \end{adjustwidth}
  ...
  \begin{adjustwidth}{10pt}{}
    ...
    \textbf{Built} features for \impact{a distributed application to assist development in the cloud}.
  ...
  \begin{adjustwidth}{10pt}{}
    ...
    \textbf{Restructured} \impact{microservice request handling} within the company Scala backend library.
  ...
  \begin{adjustwidth}{10pt}{}
    ...
    \textbf{Leverage} \impact{industry-standard tools} such as LDAP/Kerberos, Kubernetes, and Puppet configuration management.
    \textbf{Maintain} an array of servers providing high performance computing, software mirrors, \impact{webhosting with 800k+ daily hits}, and other services to 6000+ active users and 1000+ student organizations.
